...
extern volatile uint8_t pendingStop;
extern volatile uint8_t pendingShutdown;
extern volatile uint8_t pendingTimerStop;
extern volatile uint8_t pendingStart;
